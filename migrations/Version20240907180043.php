 ...
 */
final class Version20240907180043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rent ADD installation TINYINT(1) DEFAULT 0 NOT NULL, CHANGE discount discount INT DEFAULT 0');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rent DROP transport, DROP cleaning, DROP installation, CHANGE discount discount INT DEFAULT NULL');
    }
}
