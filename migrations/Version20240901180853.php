 ...
 */
final class Version20240901180853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rent CHANGE discount discount INT DEFAULT 0');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rent CHANGE discount discount INT DEFAULT NULL');
    }
}
